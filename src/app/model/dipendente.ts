...
constructor(codiceFiscale?:string, nome?:string, cognome?:string, 
            ...
            indirizzo?:string, cittaResidenza?:string, cap?:string, numeroTelefonico?:string,password?:string) {

    if (codiceFiscale && nome && cognome && email && dataDiNascita && cittaNatale && indirizzo && cittaResidenza && cap && numeroTelefonico && password) {
